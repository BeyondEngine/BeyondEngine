#ifndef BEYOND_ENGINE_EDITOR_WXUICONTROL_WXWIDGETSPROPERTY_LANGUAGETEXTPROPERTYDESCRIPTION_H__INCLUDE
#define BEYOND_ENGINE_EDITOR_WXUICONTROL_WXWIDGETSPROPERTY_LANGUAGETEXTPROPERTYDESCRIPTION_H__INCLUDE

#include "wxwidgetsPropertyBase.h"

class CLanguageTextPropertyDescription : public CWxwidgetsPropertyBase
{
    typedef CWxwidgetsPropertyBase super;
public:
    CLanguageTextPropertyDescription(CSerializer* pSerializer);
    CLanguageTextPropertyDescription(const CLanguageTextPropertyDescription& rRef);

    virtual ~CLanguageTextPropertyDescription();
