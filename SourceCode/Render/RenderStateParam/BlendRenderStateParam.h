...
public:
    enum EBlendParamType
    {
        ...
        eBPT_ONE_MINUS_SRC_COLOR = 0x0301, //GL_ONE_MINUS_SRC_COLOR
        eBPT_DEST_COLOR = 0x0306, //GL_DST_COLOR
        eBPT_ONE_MINUS_DEST_COLOR = 0x0307, //GL_ONE_MINUS_DST_COLOR
        eBPT_SRC_ALPHA = 0x0302, //GL_SRC_ALPHA
        eBPT_ONE_MINUS_SRC_ALPHA = 0x0303, //GL_ONE_MINUS_SRC_ALPHA
        eBPT_DEST_ALPHA = 0x0304, //GL_DST_ALPHA
        eBPT_ONE_MINUS_DEST_ALPHA = 0x0305, //GL_ONE_MINUS_DST_ALPHA
        eBPT_CONST_COLOR = 0x8001, //GL_CONSTANT_COLOR
        eBPT_ONE_MINUS_CONST_COLOR = 0x8002, //GL_ONE_MINUS_CONSTANT_COLOR
        eBPT_CONST_ALPHA = 0x8003, //GL_CONSTANT_ALPHA
        eBPT_ONE_MINUS_CONST_ALPHA = 0x8004, //GL_ONE_MINUS_CONSTANT_ALPHA
