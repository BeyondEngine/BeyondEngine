...
void MciPlayer::SetVolume(float fVolume)
{
    ...
    mciSetAudioPara.dwCallback = (DWORD)_wnd; 
    mciSetAudioPara.dwItem = MCI_DGV_SETAUDIO_VOLUME; 
    mciSetAudioPara.dwValue = (DWORD)(fVolume * 1000); //here is the value of the Volume(0--1000)
    UINT uSoundId = _soundID;
    if(uSoundId)
    {
        int error = mciSendCommand(uSoundId, MCI_SETAUDIO, MCI_DGV_SETAUDIO_VALUE | MCI_DGV_SETAUDIO_ITEM, (DWORD)(LPVOID)&mciSetAudioPara); 
        error = error;
    }
}
