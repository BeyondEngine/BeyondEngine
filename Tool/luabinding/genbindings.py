...
def main():
    ...
    cxx_generator_root = os.path.abspath(os.path.join(project_root, 'tool/luabinding/bindings-generator'))
    print 'project_root:' + project_root
    print 'cxx_generator_root:' + cxx_generator_root

    # save config to file
    config = ConfigParser.ConfigParser()
    config.set('DEFAULT', 'androidndkdir', ndk_root)
    config.set('DEFAULT', 'clangllvmdir', llvm_path)
    config.set('DEFAULT', 'BeyondEngineDir', project_root)
    ...
    try:
        ...
        tolua_root = '%s/tool/luabinding' % project_root
        output_dir = '%s/sourceCode/script/auto' % project_root
        cmd_args = {'beyondengine.ini' : ('BeyondEngine', 'lua_BeyondEngine_auto'),\
                    'StarRaiders.ini' : ('StarRaiders', 'lua_StarRaiders_auto'),\
                    'Animation.ini' : ('Animation', 'lua_Animation_auto')}
        target = 'lua'
